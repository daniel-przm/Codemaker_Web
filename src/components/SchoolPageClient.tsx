            ...
            <section className="py-24 px-6 bg-[#00477A] text-white overflow-hidden relative">
                ...
                <div className="max-w-5xl mx-auto space-y-12 relative z-10">
                    <h2 className="text-4xl md:text-5xl font-medium tracking-tight">
                        Contenidos Codemaker
                    </h2>
                    <div className="space-y-6 text-lg text-slate-200 opacity-90">
                        <p>
                            Trabajamos estas tecnologías de forma gradual, desde 3º de
                            primaria hasta bachillerato, empezando con contenidos básicos de
                            informática para ir avanzando hasta conceptos profesionales de
                            ingeniería.
                        </p>
                    </div>
                ...
                <div className="max-w-5xl mx-auto space-y-12">
                    <div className="space-y-4">
                        ...
                        <p className="text-slate-600 text-lg">
                            Nuestro programa se divide en diferentes edades y niveles. En{" "}
