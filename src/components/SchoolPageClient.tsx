...
function LevelCard({ level }: { level: string }) {
    ...
    return (
        <div
            ...
            className="bg-white rounded-2xl p-8 shadow-sm border-2 hover:shadow-md transition-all flex flex-col gap-4"
        >
            <div
        ...
        <>
            ...
            <section className="hero-blue relative pt-32 pb-24 px-6 text-white overflow-hidden">
                ...
                <div className="max-w-5xl mx-auto relative z-10 space-y-5">
                    <div className="text-xs font-black uppercase tracking-widest opacity-60 space-y-0.5">
                        <p>Proyecto Educativo Codemaker</p>
            ...
            <section className="py-24 px-6 bg-[#00477A] text-white overflow-hidden relative">
                ...
                <div className="max-w-5xl mx-auto space-y-12 relative z-10">
                    ...
                    <div className="space-y-6 text-lg text-slate-200 opacity-90">
                        <p>
                            Trabajamos todas las nuevas tecnologías adaptadas a niveles de
                            primaria, secundaria y bachillerato, empezando con contenidos
                            básicos de informática para ir avanzando hasta conceptos
            ...
            {/* Levels Section */}
            <section className="py-24 px-6 bg-slate-50 patron-puntos border-t border-slate-100">
                <div className="max-w-5xl mx-auto space-y-12">
                    <div className="space-y-4">
                        ...
                        <p className="text-slate-600 text-lg">
                            Nuestro programa se divide en diferentes edades y niveles. Estos son
                            los que ofertamos en {school.nombre}:
                        </p>
                    </div>
                    ...
                    <div className="space-y-4">
                        <details className="group bg-white rounded-3xl border border-slate-100 overflow-hidden transition-all hover:border-blue-200">
                            ...
                            <ul className="px-6 pb-6 pt-2 space-y-3">
                                {school.info_general.map((item, i) => (
